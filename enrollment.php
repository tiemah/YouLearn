            ...
            <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>COM 421</td>
                    <td>Y4S2</td>
                    <td><button type="submit" class="btn btn-success" name="enroll" style="border-radius: 20px;">Enroll</button></td>
                    <td><button type="submit" class="btn btn-danger" name="discard" style="border-radius: 20px;">Discard</button></td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
